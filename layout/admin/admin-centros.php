                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                <div class="card card-stats">
                                    <a href="#modificar-centros" data-toggle="tab">
                                        <div class="card-header" data-background-color="yellow"  style="background-color: #fec60a">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card-content">
                            <div class="tab-content">
                                <?php
                                include '../../model/admin/admin-centros/tab-get-centros.php';
                                ?>
                                <div class="tab-pane" id="insertar-centros">
                                    <?php
                                include '../../model/admin/admin-centros/tab-insert-centros.php';
                                ?>
                                </div>
...
<!--  Center Data -->
<script src="../../model/admin/admin-centros/admin-centros.js" type="text/javascript"></script>
</html>